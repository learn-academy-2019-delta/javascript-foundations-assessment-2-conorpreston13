...
var helloMe = {
    ...
    height: '6.0', 
    eyes: 'blue',
    getData: function(){return this.firstName + ' ' + this.lastName + ' is ' + this.height + ' foot tall and has ' + this.eyes + ' eyes'}
}
...
console.log(mkString(randomNouns))
...
let indexLength = (str) => {
    return str.map(value => value.length)
}
console.log(indexLength(randomNouns))
...
let alphabetSoup1 = (string1, string2, string3) => {
    let letters = string1 + string2 + string3
    let newArr1 = letters.split('')
    newArr1.sort()
    return newArr1.join('')
}
...
let combined = (str1, str2) => {
    ...
    // let newArr2 = both.join('')
    return `${str1[0]} ${str2[0]} ${str1[1]} ${str2[1]} ${str1[2]} ${str2[2]} ${str1[3]} ${str2[3]} ${str1[4]} ${str2[4]} ${str1[5]} ${str2[5]} ${str1[6]} ${str2[6]}`
}
